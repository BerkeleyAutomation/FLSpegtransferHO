...
class LSTMModel(nn.Module):
    ...
    def model_out(self, x):
        ...
        return out[self.num_layers - 1].tolist()
    ...
    def format_dataset(self, data_in, data_out, history):
        ...
        print("y shape = (batch_size, output_size)")
        return x, y
...
class dvrkCurrEstLSTM():
    def __init__(self, history, nb_ensemble, nb_axis):
        ...
        dir = "training/collision_detection/models/LSTM/q2/"
