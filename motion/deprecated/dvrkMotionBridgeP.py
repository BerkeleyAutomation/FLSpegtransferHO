...
class dvrkMotionBridgeP():
    def __init__(self):
        ...
        self.act_joint1 = []
        self.act_joint2 = []
        self.act_motor_current1 = []
        self.act_motor_current2 = []
    ...
    def run(self):
        while True:
            ...
            data_unpack = list(struct.unpack('=42f', data_recv))
            ...
            self.act_motor_current1 = data_unpack[28:35]
            self.act_motor_current2 = data_unpack[35:42]
...
if __name__ == "__main__":
    ...
    #     perception.set_pose(pos1=pos1, rot1=q0, jaw1=jaw1, pos2=pos2, rot2=q2, jaw2=jaw2)
