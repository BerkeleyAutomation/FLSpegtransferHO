...
from FLSpegtransfer.motion.deprecated.dvrkMotionBridgeC import dvrkMotionBridgeC
from FLSpegtransfer.motion.dvrkKinematics import dvrkKinematics
import FLSpegtransfer.utils.CmnUtil as U

class dvrkVerification():
    def __init__(self):
        # objects
        root = '/home/hwangmh/pycharmprojects/FLSpegtransfer/'
        dir = 'motion/'
        self.dvrk = dvrkMotionBridgeC(18, 3, root + dir + 'model_red_peg.out', use_history=True)
    ...
    def load_trajectory(self, filename):
        ...
        pos = np.array([dvrkKinematics.fk_position(q[0], q[1], q[2], 0, 0, 0, L1=self.BD.L1, L2=self.BD.L2, L3=0, L4=0) for q in joint])
        q1 = joint[:, 0]
        q2 = joint[:, 1]
        q3 = joint[:, 2]
        q4 = joint[:, 3]
    ...
    def verify_calibrated_motion(self):
        jaw = [5. * np.pi / 180.]
        ...
        self.collect_data_joint(j1,j2,j3,j4,j5,j6, jaw, transform='known')

    def collect_data_joint(self, j1, j2, j3, j4, j5, j6, jaw, transform='known'):    # j1, ..., j6: joint trajectory
        try:
            ...
            for qd1,qd2,qd3,qd4,qd5,qd6 in zip(j1,j2,j3,j4,j5,j6):
                ...
                img_color, img_depth, img_point = self.BD.img_crop(self.zivid.color, self.zivid.depth, self.zivid.point)
...
if __name__ == "__main__":
    cal = dvrkVerification()
    cal.verify_calibrated_motion()