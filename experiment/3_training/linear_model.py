...
#     train_q_des = np.load(train_file_path + 'joint_des.npy')    # desired joint angles: [q0, ..., q6]
#     train_q_act = np.load(train_file_path + 'joint_act.npy')    # actual joint angles: [q0, ..., q6]

verif_file_path = '../verification_dataset/peg_transfer/'
# verif_file_path = train_file_path
verif_q_des = np.load(verif_file_path + 'joint_des.npy')  # desired joint angles: [q0, ..., q6]
verif_q_act = np.load(verif_file_path + 'joint_act.npy')  # actual joint angles: [q0, ..., q6]
