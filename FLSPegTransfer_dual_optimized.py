...
from FLSpegtransfer.motion.dvrkPegTransferMotionDualArmOptimized import dvrkPegTransferMotionDualArmOptimized
...
class FLSPegTransfer:
    def __init__(self, use_simulation=True, which_camera='inclined'):
        ...
        self.dvrk_motion = dvrkPegTransferMotionDualArmOptimized()
