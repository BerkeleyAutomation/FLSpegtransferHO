from FLSpegtransfer.trash.PegMotionOptimizer_XYZR import PegMotionOptimizer
...
pos, vel, acc, t = opt.optimize_motion(pose1, pose2, pose3, max_vel=dvrkVar.v_max, max_acc=dvrkVar.a_max, t_step=0.01, horizon=50, print_out=True, visualize=False)
